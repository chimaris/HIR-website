...
const SearchSection = () => {
  return (
    <div className='w-[90%] my-12 m-auto'>
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap items-center justify-center md:justify-around gap-24 md:gap-1 w-[95%]">
            <div className="flex flex-col items-center justify-center bg-[#008DC9] hover:bg-[#FFC914] w-[95%] md:w-[30%] h-[200px] rounded-md pt-12">
                ...
                <div className='relative -bottom-6 bg-white text-black text-center h-[150px] w-[300px] md:h-[115px] md:w-[230px] xl:h-[150px] xl:w-[300px] rounded-[50%] py-8'>
                    <p className='text-[24px] md:text-[14px] xl:text-[24px] px-16'>Looking for Specific maps?</p>
                </div>
            </div>
            <div className="flex flex-col items-center justify-center bg-[#008DC9] hover:bg-[#FFC914] w-[95%] md:w-[30%] h-[200px] rounded-md pt-12">
                <div className='flex flex-col items-center gap-2 text-white pt-12'>
                ...
                <div className='relative -bottom-6 bg-white text-black text-center h-[150px] w-[300px] md:h-[115px] md:w-[230px] xl:h-[150px] xl:w-[300px] rounded-[50%] py-8'>
                    <p className='text-[24px] md:text-[14px] xl:text-[24px] px-16'>Looking for just the data?</p>
                </div>
            </div>
            <div className="flex flex-col items-center justify-center bg-[#008DC9] hover:bg-[#FFC914] w-[95%] md:w-[30%] h-[200px] rounded-md pt-12">
                <div className='flex flex-col items-center gap-2 text-white pt-12'>
