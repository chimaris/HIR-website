...
const MapSection = () => {
  return (
    <section className="flex flex-col bg-[#CCE8F4] py-[100px] px-5 w-[100%]">
			...
			<div className="flex flex-col md:flex-row md:flex-wrap items-center m-auto gap-1 my-20 justify-center w-[100%]">
				<div className="flex flex-col items-center justify-center text-center gap-1 md:w-[44%] lg:w-[23%] xl:w-[14%]">
