    ...
    <div className='flex flex-col md:flex-row justify-start gap-12 bg-[#2C3F4D] px-3 py-5 h:auto md:h-48 text-white'>
      <div className='flex flex-col gap-8'>
        ...
        <form className="max-w-sm relative">
                <button className="p-2 w-32 h-11 text-white bg-[#008DC9] rounded-full absolute left-60 cursor-pointer">
                    SUBSCRIBE
                </button>
                <input
                 type="text"
      ...
      <div className='flex flex-col gap-8 w-64'>
        ...
        <div className="max-w-sm relative">
                <button className="p-3 text-white bg-[#008DC9] rounded-full absolute left-52 cursor-pointer">
      ...
      <div>
        <div className="max-w-sm relative mt-[4.5rem]">
                <button className="p-3 text-white bg-[#008DC9] rounded-full absolute left-20 cursor-pointer">
                  <FaAngleDown className='text-2xl'/>
                </button>
                <select className="p-2.5 w-[100%] h-11 text-gray-500 bg-white border rounded-full shadow-sm outline-none appearance-none focus:border-indigo-600">
